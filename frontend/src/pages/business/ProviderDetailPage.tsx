    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-amber-800">Podgląd Twojego profilu</p>
                  <p className="text-sm text-amber-600">Tak widzą Cię klienci. Rezerwacje są wyłączone w tym widoku.</p>
                </div>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          {/* Right Column - Booking or Owner Panel */}
            ...
            {isOwner ? (
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-20">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-bold mb-2">Tryb podglądu</h3>
                  <p className="text-gray-600 text-sm mb-6">
                    To jest podgląd Twojego profilu. Klienci widzą te same informacje.
                  </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <button 
                      onClick={() => navigate('/biznes/uslugi')} 
                      className="w-full py-3 border-2 border-gray-200 text-gray-700 rounded-xl font-medium hover:border-emerald-500 hover:text-emerald-600 transition-colors"
                    >
                      📋 Zarządzaj usługami
                    </button>
                    <button 
                      onClick={() => navigate('/biznes/godziny-pracy')} 
                      className="w-full py-3 border-2 border-gray-200 text-gray-700 rounded-xl font-medium hover:border-emerald-500 hover:text-emerald-600 transition-colors"
                    >
                      🕐 Godziny pracy
                    </button>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-xl text-left">
                    <p className="text-sm text-blue-700">
                      <strong>💡 Wskazówka:</strong> Uzupełnij wszystkie informacje o usługach i godzinach pracy, aby zwiększyć liczbę rezerwacji.
                    </p>
                  </div>
                </div>
              </div>
            ) : (
              /* Normal Booking Panel for Customers */
              <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-20">
